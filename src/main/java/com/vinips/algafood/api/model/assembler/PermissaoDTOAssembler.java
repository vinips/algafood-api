...
public class PermissaoDTOAssembler {
	...
	public List<PermissaoDTO> toCollectionDTO(Collection<Permissao> permissaoList) {
		return permissaoList.stream().map(permissao -> toDTO(permissao)).collect(Collectors.toList());
	}
