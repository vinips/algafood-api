...
public interface RestauranteFormaPagamentoControllerOpenApi {
	...
	@ApiOperation("Lista as Formas de Pagamento Restaurante vinculadas a um Restaurante pelo ID")
	@ApiResponses({
	...
	@ApiOperation("Associa uma Forma de Pagamento a um Restaurante pelos IDs")
	@ApiResponses({
	...
	@ApiOperation("Desassocia uma Forma de Pagamento de um Restaurante pelos IDs")
	@ApiResponses({
		@ApiResponse(responseCode = "204", description = "Forma de Pagamento desvinculado ao Restaurante"),
		@ApiResponse(responseCode = "404", description = "Restaurante ou Forma de Pagamento não encontrados", content = @Content(mediaType = "application/json", schema = @Schema(implementation = Problem.class)))
	})
