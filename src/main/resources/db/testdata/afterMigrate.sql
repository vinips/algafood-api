...
-- PEDIDO
INSERT INTO pedido (id, data_cancelamento, data_confirmacao, data_criacao, data_entrega, status, subtotal, taxa_frete, valor_total, usuario_cliente_id, forma_pagamento_id, restaurante_id, endereco_cep, endereco_logradouro, endereco_numero, endereco_complemento, endereco_bairro, endereco_cidade_id) VALUES (1, null, null, utc_timestamp, null, 'CRIADO', 45.00, 4.99, 49.99, 1, 2, 2, '88136-311', 'Rua das bananeiras', '199', 'casa', 'Loteamento Jurema', 1);
INSERT INTO pedido (id, data_cancelamento, data_confirmacao, data_criacao, data_entrega, status, subtotal, taxa_frete, valor_total, usuario_cliente_id, forma_pagamento_id, restaurante_id, endereco_cep, endereco_logradouro, endereco_numero, endereco_complemento, endereco_bairro, endereco_cidade_id) VALUES (2, null, utc_timestamp, utc_timestamp, utc_timestamp, 'ENTREGUE', 20.99, 10.01, 31.00, 3, 3, 1, '88136-117', 'Servidão Amaurí Junior', '1985', 'Mansão', 'Alphaville', 4);
INSERT INTO pedido (id, data_cancelamento, data_confirmacao, data_criacao, data_entrega, status, subtotal, taxa_frete, valor_total, usuario_cliente_id, forma_pagamento_id, restaurante_id, endereco_cep, endereco_logradouro, endereco_numero, endereco_complemento, endereco_bairro, endereco_cidade_id) VALUES (3, null, utc_timestamp, utc_timestamp, null, 'CONFIRMADO', 39.90, 0.10, 40.00, 1, 1, 2, '88136-311', 'Rua das Jacas', '231', 'Apartamento', 'Praia da Philco', 2);
